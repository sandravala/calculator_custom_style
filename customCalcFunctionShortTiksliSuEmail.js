	...
	if(ismokuPavadinimas === 'bendraSuma' && (mamosPajamos > 0 || tecioPajamos > 0)) {
			...
			rows += `<tr>
				...
				rows += `<tr>
					...
					<td style='text-align: left; font-size: .85em; padding-left: .3em; font-weight: ${fontWeight};'><div class='bendraSuma'>${data[i].suma}<div></td>
					<td style='text-align: left; font-size: .85em; padding-left: .3em; font-weight: ${fontWeight};'><div class='bendraSuma'>${data[i].sumaPoMokesciu}<div></td>
